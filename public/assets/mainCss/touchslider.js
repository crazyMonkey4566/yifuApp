...
(function (window, undefined) {
    ...
    TouchSlider.prototype = {
        ...
        setup: function () {
            ...
            this.opt.timeout = Math.max(this.opt.timeout, this.opt.speed);
            this.touching = !!ADSupportsTouches;
            this.css3transition = !!ADSupportsTransition;
        ...
        slide: function (index, speed) {
            ...
            this.opt.before.call(this, index, this.slides[this.index]);
            run();
        },
        begin: function () {
